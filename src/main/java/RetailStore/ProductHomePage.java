...
public class ProductHomePage extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ProductHomePage
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductHomePage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProductHomePage().setVisible(true);
            }
        });
    }
